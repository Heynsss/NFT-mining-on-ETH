...
let account = null;
let contract = null;
const apiKey= 'GWCEXCTSUI3VIH6ATKTAKKZGCZ1TF824UD';
const endpoint = "https://api-rinkeby.etherscan.io/api"
const ADDRESS = '0xFf5e9a09B61B3A6368eDDD82fDeaE5784c8a9D47';
const ABI = [
	{
		"inputs": [],
        ...
        <div className='row'>
          <form class="gradient col-lg-5 mt-5" style={{borderRadius:"25px",boxShadow:"1px 1px 15px #000000"}}>
            ...
            <label style={{color:"#FFFFFF"}}>Price 0.05 ETH each mint.</label>
    	      <h6 style={{color:"#FFFFFF", marginTop:'5px'}}> Tokens minted = {balance} of ...</h6>
            <Nav className="justify-content-center" >
              <Nav.Item>
                <Nav.Link style={{color:'#FFFFFF'}}href="https://onegrid.me">OneGrid</Nav.Link>
              </Nav.Item>
            </Nav>
          </form>
	      </div>
